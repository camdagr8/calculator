        ...
        "typography": {
            ...
            "elements": {
                "paragraph": {
                    ...
                    "component": require("./typography/elements/Paragraph").default,
                    "readme": require("./typography/elements/Paragraph/readme").default
                },
                "headings": {
                    "type": "atom",
                    "label": "Headings",
                    ...
                    "component": require("./typography/elements/Headings").default
                },
                "text-link": {
                    "type": "atom",
                    "label": "Text Link",
                    ...
                    "component": require("./typography/elements/TextLink").default
                },
                "lists": {
                    "type": "molecule",
                    "label": "Lists",
                    ...
                    "component": require("./typography/elements/Lists").default
                },
                "article": {
                    "type": "organism",
                    "label": "Article",
                    ...
                    "component": require("./typography/elements/Article").default
                }
            }
        },
        "buttons": {
        ...
        "form": {
            ...
            "elements": {
                "text-input": {
                    ...
                    "component": require("./form/elements/TextInput").default,
                    "readme": require("./form/elements/TextInput/readme").default
                },
                "text-area": {
                    "type": "atom",
                    "label": "Text Area",
                    ...
                    "component": require("./form/elements/TextArea").default,
                    "readme": require("./form/elements/TextArea/readme").default
                },
                "number-input": {
                    "type": "atom",
                    "label": "Number Input",
                    ...
                    "component": require("./form/elements/NumberInput").default,
                    "readme": require("./form/elements/NumberInput/readme").default
                },
                "checkbox": {
                    "type": "atom",
                    "label": "Checkbox",
                    ...
                    "component": require("./form/elements/Checkbox").default,
                    "readme": require("./form/elements/Checkbox/readme").default
                },
                "radio-input": {
                    "type": "atom",
                    "label": "Radio",
                    ...
                    "component": require("./form/elements/RadioInput").default,
                    "readme": require("./form/elements/RadioInput/readme").default
                }
            }
        }
    },
